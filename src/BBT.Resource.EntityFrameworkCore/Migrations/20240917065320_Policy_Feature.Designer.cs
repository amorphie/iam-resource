...
namespace BBT.Resource.Migrations
{
    ...
    [Migration("20240917065320_Policy_Feature")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BBT.Resource.Policies.Policy", b =>
                {
                    ...
                    b.Property<string[]>("EvaluationOrder")
                        .HasColumnType("text[]");
            ...
            modelBuilder.Entity("BBT.Resource.Resources.ResourcePolicy", b =>
                {
                    ...
                    b.HasKey("ResourceId", "PolicyId");

                    b.HasIndex("PolicyId");

                    b.ToTable("ResourcePolicies", (string)null);
                });
                    ...
                    b.OwnsOne("BBT.Resource.Policies.PolicyCondition", "Condition", b1 =>
                        {
                            ...
                            b1.Property<string[]>("Rules")
                                .IsRequired()
                                .HasColumnType("text[]");

                            b1.HasKey("PolicyId");

                            b1.ToTable("PolicyConditions", (string)null);

                            b1.WithOwner()
                                .HasForeignKey("PolicyId");

                            b1.OwnsOne("BBT.Resource.Policies.PolicyTime", "Time", b2 =>
                                {
                                    b2.Property<Guid>("PolicyConditionPolicyId")
                                        .HasColumnType("uuid");
                                    ...
                                    b2.ToTable("PolicyConditions");

                                    b2.WithOwner()
                                        .HasForeignKey("PolicyConditionPolicyId");
                                });
            ...
            modelBuilder.Entity("BBT.Resource.Resources.ResourcePolicy", b =>
                {
                    b.HasOne("BBT.Resource.Policies.Policy", null)
                        .WithMany()
                        .HasForeignKey("PolicyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
