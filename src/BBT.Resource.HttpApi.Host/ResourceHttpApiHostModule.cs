...
using BBT.Resource.HealthChecks;
using BBT.Resource.Swagger;
using BBT.Prism;
...
public class ResourceHttpApiHostModule : PrismModule
{
    ...
    {
        context.Services.AddEndpoints<ResourceHttpApiHostModule>();
    }
    ...
    public async override Task OnPostApplicationInitializationAsync(ApplicationInitializationContext context)
    {
        if (!context.GetEnvironment().IsProduction())
        {
            ...
            await scope.ServiceProvider
                .GetRequiredService<ResourceDbMigrationService>()
                .MigrateAsync();
        }
    }
}