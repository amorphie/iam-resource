    ...
    IResourceRepository resourceRepository) : IDataSeedContributor
{
    ...
    private List<Rule> GetRules()
    {
        ...
        [
            ...
            new Rule(testData.RuleId_2, "Rule_2", "Utils.CallApiGet(\"https://google.com/card/security/match/\"+header.user_reference+\"/\"+header.card_number,header).IsSuccessStatusCode == true")
        ];
    }
    ...
    {
        var mock1 = new Resources.Resource(testData.ResourceId_1, testData.ResourceGroupId_1, ResourceType.GET, "/api/users/([^/]+)");
        ...
        var mock2 = new Resources.Resource(testData.ResourceId_2, testData.ResourceGroupId_1, ResourceType.POST, "/api/users([^/]+)");
        ...
        var mock3 = new Resources.Resource(testData.ResourceId_3, testData.ResourceGroupId_1, ResourceType.GET, "/api/users/([^/]+)/roles");
